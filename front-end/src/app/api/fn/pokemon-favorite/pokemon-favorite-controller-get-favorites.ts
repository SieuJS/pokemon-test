...
export function pokemonFavoriteControllerGetFavorites(http: HttpClient, rootUrl: string, params?: PokemonFavoriteControllerGetFavorites$Params, context?: HttpContext): Observable<StrictHttpResponse<void>> {
